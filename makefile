...
install_deps:
	@command -v apt >/dev/null 2>&1 && apt update && apt install -y auditd audispd-plugins openssh-server git inotify-tools nginx || echo "apt not found, skipping dependency installation"
